...
/**
 * HappyCapy Discord Customer Service Bot - Fully Automated
 *
 * This bot automatically:
 * 1. Listens for Discord messages (mentions or in support channel)
 * 2. Calls Claude API with the happycapy-discord-service skill
 * 3. Sends AI-generated response back to Discord
 *
 * Setup:
 * 1. npm install discord.js dotenv @anthropic-ai/sdk
 * 2. Configure .env with DISCORD_BOT_TOKEN and ANTHROPIC_API_KEY
 * 3. Run: node discord-bot-auto.js
 */
...
/**
 * Generate customer service response using Claude API with skill
 */
...
Generate a helpful customer service response.`;
    ...
    console.log('🤖 Generating response with Claude API...');
...
discordClient.on('messageCreate', async (message) => {
  ...
  try {
    // Generate response using Claude API with skill
